...
from lib.datasets import Imagenet64
from celeb_dataset import CelebAHQ
...
def get_dataset(args):
    ...
    def fast_collate(batch):
        ...
        targets = torch.zeros((len(imgs), im_dim, im_size, im_size),
                              dtype=torch.uint8)
...
def main():
    ...
    if args.distributed: model = dist_utils.DDP(model,
                                                ...
                                                output_device="cuda:%d" % torch.cuda.current_device())
